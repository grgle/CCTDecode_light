...
"""
import sys
import ulab as np #numpy replacement
from ulab import * #numpy replacement
import cv2
import os
...
def CCT_extract(img,N,R,color='black'):
...
if __name__ == '__main__':
   ...
   code_table,processed_img=CCT_extract(raw_img,bit_n,threshold)
   processed_img.save("example.jpg")
